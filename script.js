                ...
                if (data.success && data.payment) {
                    if (data.payment.status === 'SUCCESS') {
                        ...
                        if (typeof gtag !== 'undefined') {
                            const transactionId = `quickmart_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
                            const conversionValue = ACTIVATION_FEE; // 160 KSH
                            
                            // Track conversion for all Google Ads accounts (including new ones)
                            const googleAdsAccounts = [
                                'AW-17621053552', // New account 1
                                'AW-17609232848', // New account 2  
                                'AW-17631106713', // New account 3
                                'AW-17548656857', // Existing accounts
                                'AW-17550600583',
                                'AW-17543477081',
                                'AW-17543749270',
                                'AW-17541392073'
                            ...
                            console.log('Conversion tracked for all QuickMart accounts:', {
                                transactionId,
                                value: conversionValue,
